									...
									<c:forEach items="${allActions}" var="act">
										<tr>
											...
											<td class="text-center"><input type="text"
												id="title-${act.actid}" name="title-${act.actid}"
												class="form-control input-sm" value="${act.title}">
											</td>
											<td class="text-center"><input type="text"
												id="url-${act.actid}" name="url-${act.actid}"
												class="form-control input-sm" value="${act.url}"></td>
											<td class="text-center">
												<button class="btn btn-primary" id="updateBtn-${act.actid}">
