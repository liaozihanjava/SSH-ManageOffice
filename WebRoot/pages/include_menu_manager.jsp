...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
	<div class="navbar-header">
		<a class="navbar-brand" href="pages/jsp/manager/manager_index.jsp"><strong>办公室管理系统（项目经理）</strong></a>
	</div>
	...
	<ul class="nav navbar-nav navbar-right">
		<li class="dropdown"><a href="javascript:;"
			...
			<ul class="dropdown-menu main-list">
				...
				<li><a href="pages/jsp/manager/ManagerUpdateAction!updatePre.action"><i class="glyphicon glyphicon-info-sign"></i>&nbsp;个人资料</a></li>
				<li class="divider"></li>
